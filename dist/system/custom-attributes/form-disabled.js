System.register(["aurelia-templating", "aurelia-dependency-injection"], function (exports_1, context_1) {
    ...
    var aurelia_templating_1, aurelia_dependency_injection_1, ReFormDisabledCustomAttribute;
    return {
        setters: [
        ...
        execute: function () {
            ReFormDisabledCustomAttribute = /** @class */ (function () {
                ...
                ReFormDisabledCustomAttribute = __decorate([
                    aurelia_templating_1.customAttribute('re-form-disabled'),
                    aurelia_dependency_injection_1.inject(Element)
                ], ReFormDisabledCustomAttribute);
                return ReFormDisabledCustomAttribute;
            }());
            exports_1("ReFormDisabledCustomAttribute", ReFormDisabledCustomAttribute);
        }
    };
});
